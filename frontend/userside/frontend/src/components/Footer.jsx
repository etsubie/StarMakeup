            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 py-10 max-md:max-w-sm max-md:mx-auto">
                ...
                <div className="lg:mx-auto">
                    ...
                    <ul className="text-sm  transition-all duration-500">
                        ...
                        <li className="mb-6">
                            <a href="javascript:;" className="cursor-pointer  text-gray-600 hover:text-gray-900">About Us</a>
                        </li>
                        <li className="mb-6">
                            <a href="javascript:;" className="cursor-pointer  text-gray-600 hover:text-gray-900">Services</a>
                        </li>
                    </ul>
                </div>
                <div className="lg:mx-auto">
                    ...
                    <ul className="text-sm  transition-all duration-500">
                        <li className="mb-6">
                            <a href="javascript:;" className="cursor-pointer text-gray-600 hover:text-gray-900">Nail</a>
                        </li>
                        <li className="mb-6">
                            <a href="javascript:;" className="cursor-pointer  text-gray-600 hover:text-gray-900">MakeUp</a>
                        </li>
                        <li>
                            <a href="javascript:;" className="cursor-pointer  text-gray-600 hover:text-gray-900"></a>
                        </li>
                    </ul>
                </div>
                <div className="lg:mx-auto">
