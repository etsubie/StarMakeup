      ...
      >
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              {/* Dashboard */}
              <SidebarLinkGroup activecondition={pathname === "/" || pathname.includes("Instdashboard")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
          ...
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h11M9 21H7a2 2 0 01-2-2V7a2 2 0 012-2h10a2 2 0 012 2v4m-6 14v-6m0 0H5m14 0h-5m-4 0v-6m0 0V7"></path>
        </svg>                           
              ...
              {/*my course*/}
              <SidebarLinkGroup activecondition={pathname.includes("my course")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/* Student Progress */}
              <SidebarLinkGroup activecondition={pathname.includes("Student Progress")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
