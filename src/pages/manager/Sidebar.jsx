            ...
            <li className="mb-1 last:mb-0">
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium ml-2">Create Courses"</span>
                </div>
              </NavLink>
            </li>
            <li className="mb-1 last:mb-0">
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium ml-2">List Courses</span>
                </div>
              </NavLink>
              <NavLink
                end
                to="/coordinator/EditCourses"
                className={({ isActive }) =>
                  `block transition duration-150 truncate ${
                    isActive
                      ? "text-violet-500"
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium ml-2">  Edit Courses</span>
                </div>
              </NavLink>
