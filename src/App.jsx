...
import CreateCourses from './pages/coordinator/CreateCourse';
...
import FeedStudent from './pages/manager/FeedStudent';
...
import EditRole from './pages/manager/EditRole';
  ...
  return (
    <Routes>
      ...
      <Route path="/coordinator/CreateCourses" element={<CreateCourses/>} />
       {/* <Route path="/coordinator/EditCourses" element={<EditCourses/>} /> */}
      ...
      <Route path="/manager/EditRole" element={<EditRole />} />
